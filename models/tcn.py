...
class TemporalLayer(Layer):
    ...
    def __init__(self,
        ...
        super(TemporalLayer, self).__init__(**kwargs)
    ...
    def build(self, input_shape):
        ...
        with K.name_scope(self.name):  # name scope used to make sure weights get unique names
            ...
            super(TemporalLayer, self).build(input_shape)  # done to make sure self.built is set True

    def call(self, inputs, training=None):
        """
        Returns: A tuple where the first element is the residual model tensor, and the second is the skip connection tensor.
        """
        x = inputs
...
class TemporalConvNet(Layer):
    ...
    def build(self, input_shape):
        ...
        # list to hold all the member TemporalLayer
        self.residual_blocks = []
        ...
        for s in range(self.nb_stacks):
            for d in self.dilations:
                self.residual_blocks.append(TemporalLayer(dilation_rate=d,
